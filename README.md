...
`tests` directory contains a test suite that covers most of the target instructions and language features. Since this interpreter does not implement all possible instructions, some tests are expected to fail. To run tests, use:
```shell
